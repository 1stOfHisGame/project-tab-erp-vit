...
$usr_name = "SELECT stud_name FROM student where roll_no = '$a'";
...
$sql = "SELECT proj_id from student where roll_no = '$a'";
$sql = $conn->query($sql);
$result = $sql->fetch_assoc();
if($result == NULL)
	echo "Project Alloted: "."No";
else{
	echo "Project Alloted: "."Yes<br>";
...
?>
	...
	<table>
		...
		<tr>
			<th>1.</th>
			<th><?php	echo $_SESSION['weeks'][0][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][0][1];	?></th>
		</tr>
		<tr>
			<th>2.</th>
			<th><?php	echo $_SESSION['weeks'][1][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][1][1];	?></th>
		</tr>
		<tr>
			<th>3.</th>
			<th><?php	echo $_SESSION['weeks'][2][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][2][1];	?></th>
		</tr>
		<tr>
			<th>4.</th>
			<th><?php	echo $_SESSION['weeks'][3][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][3][1];	?></th>
		</tr>
		<tr>
			<th>5.</th>
			<th><?php	echo $_SESSION['weeks'][4][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][4][1];	?></th>
		</tr>
		<tr>
			<th>6.</th>
			<th><?php	echo $_SESSION['weeks'][5][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][5][1];	?></th>
		</tr>
		<tr>
			<th>7.</th>
			<th><?php	echo $_SESSION['weeks'][6][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][6][1];	?></th>
		</tr>
		<tr>
			<th>8.</th>
			<th><?php	echo $_SESSION['weeks'][7][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][7][1];	?></th>
		</tr>
		<tr>
			<th>9.</th>
			<th><?php	echo $_SESSION['weeks'][8][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][8][1];	?></th>
		</tr>
		<tr>
			<th>10.</th>
			<th><?php	echo $_SESSION['weeks'][9][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][9][1];	?></th>
		</tr>
		<tr>
			<th>11.</th>
			<th><?php	echo $_SESSION['weeks'][10][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][10][1];	?></th>
		</tr>
		<tr>
			<th>12.</th>
			<th><?php	echo $_SESSION['weeks'][11][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][11][1];	?></th>
		</tr>
		<tr>
			<th>13.</th>
			<th><?php	echo $_SESSION['weeks'][12][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][12][1];	?></th>
		</tr>
		<tr>
			<th>14.</th>
			<th><?php	echo $_SESSION['weeks'][13][0];	?></th>
			<th><?php	echo $_SESSION['weeks'][13][1];	?></th>
		</tr>
